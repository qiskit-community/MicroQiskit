...
* [Pixelmon](examples/pixelmon_microbit.py) - A simple game in which you collect animals by moving around a land generated by qubits. For the [micro:bit](https://microbit.org/).
